<svg xmlns="http://www.w3.org/2000/svg" class="d-none">
    <?php if ($edit): ?>
        <symbol viewBox="0 0 24 24" id="fe-edit">
            <path fill="currentColor" d="M5 20h14a1 1 0 0 1 0 2H5a1 1 0 0 1 0-2m-1-5L14 5l3 3L7 18H4zM15 4l2-2l3 3l-2.001 2.001z" />
        </symbol>
    <?php endif; ?>
    <?php if ($trash): ?>
        <symbol viewBox="0 0 24 24" id="fe-trash">
    ...
    <?php endif; ?>
    <?php if ($close): ?>
        <symbol viewBox="0 0 24 24" id="fe-close">
