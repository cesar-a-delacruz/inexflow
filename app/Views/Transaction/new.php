    ...
    <tbody>
      <?php if (!empty($items->income)): ?>
        <?php for ($i = 0; $i < count($items->income); $i++): ?>
          <tr data-index="<?= $i ?>" data-id="<?= $items->income[$i]->id->toString() ?>">
            <td><?= $i + 1 ?></td>
            ...
            <td class="amount"><?= $items->income[$i]->displayProperty('stock') ?></td>
    ...
    <tbody>
      <?php if (!empty($items->expense)): ?>
        <?php for ($i = 0; $i < count($items->expense); $i++): ?>
          <tr data-index="<?= $i ?>" data-id="<?= $items->expense[$i]->id->toString() ?>">
            <td><?= $i + 1 ?></td>
